...
<button type="button" class="btn" > <a href="<?=base_url('dishes')?>"><i class="fa fa-list"></i>Assine Page</a></button><br><br>
  ...
  <form action="<?php echo base_url();?>custom-page/do1/Add" method="post">
     <div class="form-group row">
          <label for="linkName" class="col-sm-2 col-form-label">Link Name</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputPassword3" name="linkName" >
        ...
        <div class="form-group row">
          <label for="content" class="col-sm-2 col-form-label">Status</label>
            ...
            <div class="col-sm-6">
             <select type="text" class="form-control" id="inputPassword3" name="statuss">
       ...
       <div class="form-group row" >
         <div class="col-sm-6">
        <button type="submit" class="btn btn-primary" style="margin-left:60%; width:200px; height:35px;" <?php if(!$this->session->ins_id){echo "disabled";}?>>Submit</button>
        </div>
          </div>
