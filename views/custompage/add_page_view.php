...
<button type="button" class="btn" > <a href="<?=base_url('dishes')?>"><i class="fa fa-list"></i>Assine Page</a></button><br><br>
  ...
  <form action="<?php echo base_url();?>custom-page/do/Add" method="post">
     <div class="form-group row">
          <label for="pageName" class="col-sm-2 col-form-label">Page Name</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputPassword3" name="pageName" >
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputEmail3" name="icon" placeholder="eg. fa fa-info-circle">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <textarea type="text" class="form-control" id="inputPassword3" name="content" ></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputEmail3" name="seoTi">
          </div>
        </div>
        <div class="form-group row">
          <label for="metaDes" class="col-sm-2 col-form-label">Meta Description</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputPassword3" name="metaDes" ><br>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputEmail3" name="metaKey">
          </div>
        </div>
        <div class="form-group row">
